<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown no-arrow mx-1">
        <a class="nav-link" href="api/documentation" target="_blank" data-placement="bottom" title="home"  role="button">
          <span style="color: #70af70;font-weight: bold;border: 1px green solid;padding: 3px;border-radius: 12px;font-size: smaller;">Swagger</span>
        </a>
      </li>
      {{-- Home page --}}
      <li class="nav-item dropdown no-arrow mx-1">
